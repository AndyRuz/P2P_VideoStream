...
def find_all_videos_on_tracker(tracker_host: str = 'localhost',
                                tracker_port: int = 6000) -> dict:
    """
    Get all videos indexed on the tracker
    ...
    Returns:
        Dictionary mapping video_id to list of peers that have it
    """
    request = {'type': 'GET_ALL_VIDEOS'}
    response = connect_to_tracker(tracker_host, tracker_port, request)
